...
def cache_root() -> str:
    ...
    if ov:
        return ov
    r = _data_root()
    return join(r, "cache", "conflict", "cache") if is_remote(r) else join(r, "conflict-cache")
...
def output_root() -> str:
    ...
    if ov:
        return ov
    r = _data_root()
    return join(r, "cache", "conflict", "output") if is_remote(r) else join(r, "conflict-output")
